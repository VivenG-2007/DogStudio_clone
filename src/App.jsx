    ...
    <>
      <main>
        <div className="images">
          ...
          <img id='this-was-phone' src="/phone.png" alt="" />
          <img id='kikk-festival' src="/kikk.png" alt="" />
          <img id='kennedy-center' src="/kennedy.png" alt="" />
          <img id='royal-opera' src="/opera.png" alt="" />
        </div>
        <Canvas
          id='canvas-elem'
          style={{
