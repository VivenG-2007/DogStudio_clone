  ...
  return (
    <>
      ...
      <section>
        <div id="section-1">
          <nav>
            <div className="navelem"><svg xmlns="http://www.w3.org/2000/svg" fill='white' viewBox="0 0 401.23099 116.838">
            ...
            <a href="https://vimeo.com/836218697"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-chevron-right-icon lucide-chevron-right"><path d="m9 18 6-6-6-6" /></svg>Our Showreel</a>
            <div className="navlem">
          ...
          <div className="middle">
            ...
            <div className="right">
              <h2>Dogstudio is a multidisciplinary<br />
